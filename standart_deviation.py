...
#if we want to make it integer; mean=int((num_1 + num_2 + num_3 + num_4 + num_5 + num_6 + num_7) / 7)
print("arithmetic mean:  ",mean)

'''Let's say we have an array that has n elements. To find standart deviation, we substract every number from arithmetic mean by one by and take square of them.
And then we sum all squares and take divison by n-1. Finally we take square root.'''
...
#integer >>  standart_deviation=int(math.sqrt(sapma))
